...
const VIDEO_URL = 'https://mianimecdn.b-cdn.net/Dekoboko/episodio-10/master.m3u8';
const SUBTITLE_TRACKS_CONFIG = [
    { label: "Español", srclang: "es", src: "https://mianimecdn.b-cdn.net/Dekoboko/episodio-10/sub_spa_es.vtt", default: true },
    { label: "English", srclang: "en", src: "https://mianimecdn.b-cdn.net/Dekoboko/episodio-10/sub_eng.vtt" }
];
...
useEffect(() => {
    ...
    const updateAvailableSubtitles = () => {
        ...
        if (currentlyShowingTrackOriginalIndex !== -1) {
            ...
            const defaultConfigTrack = SUBTITLE_TRACKS_CONFIG.find(conf => conf.default);
    ...
    SUBTITLE_TRACKS_CONFIG.forEach(config => {
...
}, []); // Se ejecuta principalmente al montar. Las actualizaciones vienen de los event listeners.
